...
// Curriculum — two tracks (Development + QA), each with its own courses.
    ...
    "courses": [
      {
        ...
        "description": "A fast-paced dev primer for career-switchers who want to hit the ground running. Live classes, guided assignments, and just enough theory to make the code stick.",
        "highlights": [
      ...
      },
      {
        ...
        "description": "The full 3-month deep dive — Admin foundations, advanced Apex, LWC in depth, and real REST / SOAP integrations, capped with a deployable capstone project.",
        "highlights": [
    ...
    "courses": [
      {
        ...
        "description": "Manual + API testing built specifically around Salesforce apps — UI, data validation, and integration scenarios you'll actually be asked about in interviews.",
        "highlights": [
      ...
      },
      {
        ...
        "description": "For QA engineers who want to automate. Playwright, Provar, and Selenium against real CRM scenarios, plus CI/CD framework patterns used in production teams.",
        "highlights": [
