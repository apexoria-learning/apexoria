...
import { IMAGES, WHATSAPP_LINK, BROCHURE_URL } from "../../data";
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-5 lg:px-8 pt-28 pb-40 w-full">
        ...
        >
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center justify-center gap-2 text-white/90 font-bold px-6 py-4 rounded-full hover:text-brand-gold transition-colors"
          >
