...
test_plan:
  current_focus:
    - "Sprint 2026-08-01 — Frontend Pass 7 (Navbar expansion: add Batches/Placement/Success/FAQ back; global cross-route hash scroll fix)"
    - "GTmetrix Phase 1 — cache headers + below-fold WebP + rewrites restore"
  stuck_tasks: []
  test_all: false
